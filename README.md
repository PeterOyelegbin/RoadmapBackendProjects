...
This repository contains a list of project solutions for the [Backend Developer](https://roadmap.sh/backend?r=backend-beginner) roadmap, intending to improve coding skills from beginner to advanced.

The solution for each project is in its respective folder. The folder name is the same as the project name. Each project folder contains a `README.md` file that describes the project, the requirements, and usage.
...
4. [Weather API](https://github.com/PeterOyelegbin/RoadmapBackendProjects/tree/main/weather_api)
